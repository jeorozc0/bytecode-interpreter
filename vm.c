...
InterpretResult interpret(const char *source) {
  ...
  // Push function onto the stack to prevent GC
  push(OBJ_VAL(function));

  // Set up initial call frame for top-level function
  CallFrame *frame = &vm.frames[vm.frameCount++];
  frame->function = function;       // Store function being executed
  frame->ip = function->chunk.code; // Start at first instruction
  frame->slots = vm.stack;          // Stack starts at bottom
